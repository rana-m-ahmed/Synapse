...
function UpdatePasswordForm() {
  ...
  return (
    <div className="w-full max-w-md bg-surface-container-lowest border border-border-subtle p-8 md:p-12 shadow-[0_20px_50px_rgba(17,17,17,0.04)] z-10 relative">
      ...
      <form action={updatePassword} className="space-y-6 flex flex-col">
        <div className="space-y-2">
          ...
          <input 
            ...
            type="password" 
            required
            className="w-full bg-surface border border-border-subtle p-4 font-body-md text-charcoal-text focus:outline-none focus:border-sage-green transition-colors"
            placeholder="••••••••"
          />
        </div>
